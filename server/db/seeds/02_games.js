  ...
  return knex('games').del()
    .then(function () {
      ...
      return knex('games').insert([
        ...
        {title: 'Fortnite', rating: '8', description: 'Third person shooting game, it is Battle Royale styled.', img: 'https://pbs.twimg.com/profile_images/1088254881570250752/zJho2zyv_400x400.jpg'},
